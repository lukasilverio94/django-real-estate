...
class Property(TimeStampedUUIDModel):
    ...
    country = CountryField(
        verbose_name=_("Country"), default="NL", blank_label="select country"
    )

    city = models.CharField(
        verbose_name=_("City"), max_length=180, default="Netherlands"
    )

    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=100, default="3132HK"
    )

    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=150, default="Street A, 31C"
    )
    ...
    bathrooms = models.DecimalField(
        verbose_name=_("Bedrooms"), max_digits=4, decimal_places=2, default=1.0
    )
    ...
    cover_photo = models.ImageField(
        verbose_name=_("Main Photo"), default="/house_sample.jpg", blank=True, null=True
    )
    ...
    def save(self, *args, **kwargs):
        ...
        sef.description = str.description(self.description)
        self.ref_code = "".join(
